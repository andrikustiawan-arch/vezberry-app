...
export default function SocialLinks({ waLink, instagramLink }) {
    ...
    return (
        <div className="fixed left-4 bottom-20 md:bottom-6 z-40 flex flex-col gap-3">
            <motion.a
                href={wa}
                target="_blank"
            ...
            <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                title="Instagram"
                className="w-12 h-12 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-white rounded-full flex items-center justify-center shadow-lg"
            >
